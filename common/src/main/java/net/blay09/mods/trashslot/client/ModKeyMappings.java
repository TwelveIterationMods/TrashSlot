...
public class ModKeyMappings {
    ...
    public static void initialize() {
        keyBindToggleSlot = Kuma.createKeyMapping(new ResourceLocation(TrashSlot.MOD_ID, "toggle"))
                .withDefault(InputBinding.key(InputConstants.KEY_T))
                .withContext(KeyConflictContext.SCREEN)
                .build();

        keyBindToggleSlotLock = Kuma.createKeyMapping(new ResourceLocation(TrashSlot.MOD_ID, "toggle_lock"))
                .withContext(KeyConflictContext.SCREEN)
                .build();

        keyBindDelete = Kuma.createKeyMapping(new ResourceLocation(TrashSlot.MOD_ID, "delete"))
                .withDefault(InputBinding.key(InputConstants.KEY_DELETE))
                .withContext(KeyConflictContext.SCREEN)
                .build();

        keyBindDeleteAll = Kuma.createKeyMapping(new ResourceLocation(TrashSlot.MOD_ID, "delete_all"))
