...
public class ModKeyMappings {
    ...
    public static void initialize() {
        keyBindToggleSlot = Kuma.createKeyMapping(Identifier.fromNamespaceAndPath(TrashSlot.MOD_ID, "toggle"))
                .withDefault(InputBinding.key(InputConstants.KEY_T))
                .withContext(KeyConflictContext.SCREEN)
                .build();

        keyBindToggleSlotLock = Kuma.createKeyMapping(Identifier.fromNamespaceAndPath(TrashSlot.MOD_ID, "toggle_lock"))
                .withContext(KeyConflictContext.SCREEN)
                .build();

        keyBindDelete = Kuma.createKeyMapping(Identifier.fromNamespaceAndPath(TrashSlot.MOD_ID, "delete"))
                .withDefault(InputBinding.key(InputConstants.KEY_DELETE))
                .withContext(KeyConflictContext.SCREEN)
                .build();

        keyBindDeleteAll = Kuma.createKeyMapping(Identifier.fromNamespaceAndPath(TrashSlot.MOD_ID, "delete_all"))
